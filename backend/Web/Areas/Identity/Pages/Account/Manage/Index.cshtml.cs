...
namespace Web.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            WebIdentityUser identityUser = _userManager.ConvertToWebIdentityUser(User);
            ...
            Input = new InputModel
            {
                ...
                PaymentMethod = identityUser.PaymentMethod
            };
        ...
        public async Task<IActionResult> OnPostAsync([FromServices] ICostumerService costumerService)
        {
            ...
            await costumerService.Update(user.ConvertToCostumerDTO());
